                ...
                <div class="bg-white p-5 shadow rounded">
                        ...
                        @if($project->category_id)
                            <a href="{{ route('categories.show', $project->category) }}">
                                <span class="badge text-bg-secondary mb-1">{{ $project->category->name }}</span>
                            </a>
                        @endif
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @auth
                                <div class="btn-group btn-group-sm">
                                    @can('update', $project)
                                        <a class="btn btn-danger" href="{{ route('projects.edit', $project) }}">Editar</a>
                                    @endcan
                                    @can('delete', $project)
                                        <a class="btn btn-primary" href="#" onclick="document.getElementById('delete-project').submit()">Eliminar</a>
                                    @endcan
                                </div>
                                @can('delete', $project)
